...
var J = Object.getPrototypeOf, K4 = Object.prototype.hasOwnProperty;
...
;
var Z = (e, t, r)=>{
    if (t && typeof t == "object" || typeof t == "function") for (let o of G1(t))!K4.call(e, o) && o !== "default" && h1(e, o, {
        get: ()=>t[o]
        ,
...
function te2({ width: e , height: r , isEditorReady: s , loading: t , _ref: g , className: m , wrapperClassName: v  }) {
    return export_default3.createElement("section", {
        style: {
            ...V2.wrapper,
            width: e,
            height: r
        ...
        className: v
    }, !s && export_default3.createElement(ee2, {
        content: t
...
function Z2({ original: e , modified: r , language: s , originalLanguage: t , modifiedLanguage: g , originalModelPath: m , modifiedModelPath: v , keepCurrentOriginalModel: w , keepCurrentModifiedModel: W , theme: b , loading: P , options: E , height: A , width: B , className: G , wrapperClassName: H , beforeMount: J , onMount: K  }) {
    ...
    return export_default3.createElement(q2, {
        width: B,
        height: A,
        isEditorReady: y,
        loading: P,
...
var v4 = export_default3.createContext(null);
function $e1(e) {
    e();
}
...
function Ye(e) {
    ...
    var o = t || v4;
    return export_default3.createElement(o.Provider, {
        value: n
    }, a);
}
var Ke = Ye;
...
const ResultsComponent = ({ results , handleContextMenu , handleClick , display  })=>{
    if (display === "table") {
        return export_default3.createElement(ResultTable, {
            rows: results.rows,
    ...
    const rows = results.rows?.map((r)=>Object.fromEntries(Object.entries(r).map(([column, value], i)=>{
            if (types[results?.fields?.[i].fieldType ?? 0] === "date" && (typeof value === "string" || typeof value === "number")) {
                return [
                    column,
...
const TableDataTab = ({})=>{
    ...
    xe(()=>{
        if (table) {
            query(`SELECT * FROM \`${database}\`.\`${table}\` LIMIT 1000;`).then(setResults);
        }
    }, [
        table
    ]);
